...
const VirginiaChart = (props) => {
  const {
    ...
    dataTypes = [
      {
        key: `../virginia_data/VA_ESTAB.csv`,
        label: "ESTAB",
        valueColumn: "Total",
      ...
      {
        key: `../virginia_data/VA_SAIDI.csv`,
        label: "SAIDI",
        valueColumn: "SAIDI",
      ...
      {
        key: `../virginia_data/VA_SAIFI.csv`,
        label: "SAIFI",
        valueColumn: "SAIFI",
        description:
    ...
    geojsonPath = `../virginia_data/va_counties_formatted.geojson`,
  } = props;
