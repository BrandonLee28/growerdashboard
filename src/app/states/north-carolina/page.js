...
const NorthCarolinaChart = (props) => {
  const {
    ...
    dataTypes = [
      {
        key: `../north_carolina_data/NC_ESTAB.csv`,
        label: "ESTAB",
        valueColumn: "Total",
      ...
      {
        key: `../north_carolina_data/NC_SAIDI.csv`,
        label: "SAIDI",
        valueColumn: "SAIDI",
      ...
      {
        key: `../north_carolina_data/NC_SAIFI.csv`,
        label: "SAIFI",
        valueColumn: "SAIFI",
        description:
    ...
    geojsonPath = `../north_carolina_data/nc_counties_formatted.geojson`,
  } = props;
...
export default NorthCarolinaChart;
